            ...
            <div class='exchange'>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <label for='swapw' v-show = "!['susdv2', 'tbtc', 'ren', 'sbtc', 'hbtc', 'uSwap','3pool'].includes(currentPool)">Swap wrapped</label>
                    </li>
                </ul>
                <div>
	...
	export default {
        ...
        methods: {
            ...
            async handle_trade() {
                ...
                if(this.swapwrapped || ['susdv2', 'tbtc', 'ren', 'sbtc', 'hbtc', 'uSwap','3pool'].includes(this.currentPool)) exchangeMethod = currentContract.swap.methods.exchange
                try {
