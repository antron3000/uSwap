<template>
	<div class="window white">
        ...
        <ul class='poolrisks' v-show="['compound', 'pax', 'iearn', 'y', 'busd', '3pool'].includes(currentPool)">
        	<li v-show="!['3pool'].includes(currentPool)">Smart contract issues with lending protocols</li>
			<li>Smart contract issues with Curve</li>
			<li v-show="['iearn', 'y', 'busd'].includes(currentPool)">Smart contract issues with iEarn</li>
        ...
        <ul class='poolrisks' v-show="['hbtc'].includes(currentPool)">
            <li>Smart contract issues with Curve</li>
            <li>Systemic issues with hBTC or wBTC</li>
        </ul>
