...
<script>
	...
	export default {
		data: () => ({
			allPools: ['compound', 'usdt', 'iearn', 'busd', 'susdv2', 'pax', 'tbtc', 'ren', 'sbtc', 'hbtc', 'uSwap','3pool'],
			pools: ['compound', 'usdt', 'iearn', 'busd', 'susdv2', 'pax', 'tbtc', 'ren', 'sbtc', 'hbtc', 'uSwap','3pool'],
		...
		computed: {
			...
			addLiquidityTopics() {
				return {
					...
					uSwap: '0x3f1915775e0c9a38a57a7bb7f1f9005f486fb904e1f84aa215364d567319a58d',
