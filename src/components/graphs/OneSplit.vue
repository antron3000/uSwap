                ...
                <div v-show='showadvancedoptions'>
                    <fieldset>
                        ...
                        <div id='poolselect'>
                            ...
                            <input id='uSwappool' type='checkbox' value='uSwap' v-model='pools'/>
                            <label for='uSwappool'>uSwap</label>
                        </div>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            pools: ['compound', 'y', 'busd', 'susdv2', 'pax', 'ren', 'sbtc', 'hbtc','uSwap'],
            maxBalance: -1,
            maxSynthBalance: -1,
            ...
            coin_precisions: [1e18, 1e6, 1e6, 1e18, 1e18, 1e18, 1e18, 1e8, 1e8, 1e18, 1e18,1e18],
            swap: [],
            addresses: [],
            coins: [],
            underlying_coins: [],
        ...
        computed: {
            ...
            selldisabled() {
                if((this.from_currency == 10 && this.to_currency != 8)) return true
                if((this.from_currency == 7 && this.to_currency == 10)) return true
                if((this.from_currency == 9 && this.to_currency == 10)) return true
